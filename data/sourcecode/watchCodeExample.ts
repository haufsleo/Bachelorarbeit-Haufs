/* 
Die in XCode festgelegte appGroupId "eventAppGroup" und die Variable
...
/* Definition der zu sendenden Daten als Array von JSON-Objekten */
var data = [{
    type: 'talk',
    title: 'Keynote',
