...
Die im folgenden Unterkapitel (\ref{sec:Objekterkennung}) näher beschriebene Objekterkennung ermöglicht ebenfalls weitreichende Eingabemöglichkeiten.
%
%
%
% - - - - - Objekterkennung - - - - - - - - 
...
Muss selbst ein technikaffiner Nutzer erst in einem längeren Seminar o.Ä. die Nutzung der App \emph{lernen}, so ist das Design der App ungenügend \cite{Hoober2011} \cite[S.~141ff]{Norman2013}.
