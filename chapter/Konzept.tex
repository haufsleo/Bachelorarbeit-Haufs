...
\todo{?}
Für \emph{watchOS} hat Apple entsprechende Human Interface Guidelines veröffentlicht 
\todo{?} 
...
Medien, die auf einer Smartglass erzeugt werden müssen ggf. komprimiert werden oder anders weiterverarbeitet werden, bevor sie verwendet werden können. So müssen Video- und Audioaufnahmen möglicherweise digital aufbereitet werden, da in der Sterilgutversorgung eine sehr starke Geräuschkulisse herrscht. Monotone Hintergrundgeräusche lassen sich heute sehr gut herausfiltern.\todo{...}