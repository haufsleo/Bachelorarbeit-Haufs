...
\todo[color=green]{Objekterkennung...}
%
%
%
% - - - - - Externe Peripherie - - - - - - - 
...
\todo[color=green]{Medienverwaltung...}
%
%
%
% - - - - - - Medienpräsentation - - - - - - - - 
...
\todo[color=green]{Medienpräsentation...}
%
%
%
...
Medien, die auf einer Smartglass erzeugt werden müssen ggf. komprimiert werden oder anders weiterverarbeitet werden, bevor sie verwendet werden können. So müssen Video- und Audioaufnahmen möglicherweise digital aufbereitet werden, da in der Sterilgutversorgung eine sehr starke Geräuschkulisse herrscht. Monotone Hintergrundgeräusche lassen sich heute sehr gut herausfiltern.
\todo[color=green]{Medienerfassung/-erstellung...}