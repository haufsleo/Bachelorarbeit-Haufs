...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{data/bilder/Enterprise_Augmented_Reality_Spending.pdf}
    \caption{Weltweite Enterprise Augmented Reality Software, Dienstleistungen und Hardware-Ausgaben, 2017-2022}
    \label{fig:Enterprise_Augmented_Reality_Spending}
\end{figure}
%
...
\end{figure}
%
Die \emph{Realwear hmt-1} ist für den professionellen Einsatz optimiert. Ähnlich der Google Glass ist ein Display am rechten Auge befestigt. 
